...
class ObatSliderAdapter(private val list: List<ObatModel>) :
    RecyclerView.Adapter<ObatSliderAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_obat_slider, parent, false)
